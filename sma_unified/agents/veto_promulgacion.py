...
class AgenteVetoPromulgacion:
    ...
    def crear_tarea(self, expediente: Dict, proyecto_info: Dict) -> Task:
        """Crear tarea CrewAI de veto/promulgacion"""
        prompt = f"""
        ...
        return Task(
            description=prompt,
            agent=self.agent,
            expected_output="JSON con evaluacion multicriterio y decision ejecutiva"
        )
